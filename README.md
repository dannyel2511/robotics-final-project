...
![imagen del robot](https://imgur.com/a/tfymU0h)


In the following sections, there are some explanations to start the robot and set the environment in the PC and onboard computer to run the project-shark package included in this repository.
# Manual operation
...
Check out that all cables are well connected in their corresponding pins. 
## On and off

* Turn on both switches at the top of the autonomous robot.
* Verify that LED red and blue are turn on. If not, return to Previous Review section.
